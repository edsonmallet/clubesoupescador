...
export function OfferDetail({ offerId }: { offerId: string }) {
  ...
  return (
    <div className="min-h-screen bg-brand-sand pb-10">
      <div className="mx-auto flex w-full max-w-3xl flex-col gap-6 px-4 py-4 md:px-8 lg:px-12">
        <DetailBackHeader title="Detalhes da oferta" />
              ...
              >
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <span className="text-xs text-brand-ink/60">
                    Disponível:{' '}
                    {formatPrice(cashbackBalance?.availableCents ?? 0)} · máx.
                    neste pedido: {formatPrice(maxUsableCashbackCents)}
                  </span>
                  <Input
                    id="cashback"
                    type="number"
